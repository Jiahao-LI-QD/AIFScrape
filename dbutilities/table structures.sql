...
CREATE TABLE Contract_Current (
    ...
    LastUpdateOfContractMarketValue date DEFAULT NULL,
    PACAmount money,
    PACFrequency varchar(255),
    DayOfThePAC DATE DEFAULT NULL,
...
CREATE TABLE Saving_Current (
    ...
    InvestedDate DATE NULL DEFAULT NULL,
...
CREATE TABLE Contract_History (
    ...
    Country varchar(255),
    AddressValidity varchar(255),
    LatestChangeOfAddress DATE DEFAULT NULL,
    MainPhone varchar(255),
    OfficePhone varchar(255),
    CellPhone varchar(255),
    ApplicantEmail varchar(255),
